...
const WARP_DOMAINS = new Set((process.env.WARP_DOMAINS || 'dl.subdl.com,rest.opensubtitles.org').split(',').map(d => d.trim()).filter(Boolean));
...
module.exports = { warpFetch, isWarpAvailable, getWarpDomains, WARP_DOMAINS };
